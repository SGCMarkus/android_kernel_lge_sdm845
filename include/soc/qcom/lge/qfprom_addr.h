#ifndef __MACH_QFPROM_ADDR_SDM845_H__
#define __MACH_QFPROM_ADDR_SDM845_H__
...
#define QFPROM_SEC_HW_KEY		(QFPROM_CTRL_BASE + 0x0388) /* 0x00780388 */
#define QFPROM_SEC_HW_KEY1		(QFPROM_CTRL_BASE + 0x0390) /* 0x00780390 */
#define QFPROM_SEC_HW_KEY2		(QFPROM_CTRL_BASE + 0x0398) /* 0x00780398 */
#define QFPROM_SEC_HW_KEY3		(QFPROM_CTRL_BASE + 0x03A0) /* 0x007803A0 */
#define QFPROM_SEC_HW_KEY4		(QFPROM_CTRL_BASE + 0x03A8) /* 0x007803A8 */

#define QFPROM_OEM_PK_HASH		(QFPROM_CTRL_BASE + 0x01C8) /* 0x007801C8 */
#define QFPROM_SEC_ENABLE		(QFPROM_CTRL_BASE + 0x0350) /* 0x00780350 */
...
#endif // __MACH_QFPROM_ADDR_SDM845_H__
