...
char *lge_ddic_cmd_set_prop_map[LGE_DDIC_DSI_CMD_SET_MAX] = {
	...
	"lge,mdss-dsi-br-enhance-on-command",
	"lge,mdss-dsi-br-enhance-off-command",
};
...
char *lge_ddic_cmd_set_state_map[LGE_DDIC_DSI_CMD_SET_MAX] = {
	...
	"lge,mdss-dsi-br-enhance-on-command-state",
	"lge,mdss-dsi-br-enhance-off-command-state",
};
