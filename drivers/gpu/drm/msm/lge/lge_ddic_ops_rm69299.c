...
static struct rm69299_iq_data rm69299_color_space_value[7] = {
	{"def", {0x00, 0xBB, 0x80, 0x47, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x0F, 0x77, 0x77, 0x77, 0x77, 0x77,
	...
	{"spo", {0x00, 0xBB, 0x80, 0x47, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x0F, 0x77, 0x77, 0x77, 0x77, 0x77,
	...
	{"exp", {0x00, 0xBB, 0x80, 0x47, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x0F, 0x77, 0x77, 0x77, 0x77, 0x77,
		 0x10, 0xF0, 0x26, 0x09, 0x5C, 0xF0, 0x80, 0xFF, 0xC7, 0x81, 0x19, 0xD0, 0x81, 0xE3, 0x07}},
};

static struct rm69299_iq_data custom_rgb_value[5] = {
	{"preset0", {0x00, 0xBB, 0x80, 0x47, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x0F, 0x77, 0x77, 0x77, 0x77, 0x77,
		     0x10, 0x59, 0x56, 0x09, 0x58, 0xE0, 0x80, 0xFF, 0xB7, 0x81, 0x17, 0xE0, 0x81, 0x50, 0x07}},
	{"preset1", {0x00, 0xBB, 0x80, 0x47, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x0F, 0x77, 0x77, 0x77, 0x77, 0x77,
		     0x10, 0xD0, 0x36, 0x09, 0x5B, 0xF0, 0x80, 0xFF, 0xC7, 0x81, 0x18, 0xD0, 0x81, 0xBC, 0x07}},
	{"preset2", {0x00, 0xBB, 0x80, 0x47, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x0F, 0x77, 0x77, 0x77, 0x77, 0x77,
		     0x10, 0xF0, 0x26, 0x09, 0x5C, 0xF0, 0x80, 0xFF, 0xC7, 0x81, 0x19, 0xD0, 0x81, 0xE3, 0x07}},
	{"preset3", {0x00, 0xBB, 0x80, 0x47, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x0F, 0x77, 0x77, 0x77, 0x77, 0x77,
		     0x10, 0x1B, 0xE7, 0x08, 0x61, 0x00, 0x81, 0xA5, 0xD7, 0x81, 0x1A, 0xC0, 0x81, 0xFB, 0x07}},
	{"preset4", {0x00, 0xBB, 0x80, 0x47, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x0F, 0x77, 0x77, 0x77, 0x77, 0x77,
		     0x10, 0x21, 0xC7, 0x08, 0x64, 0x00, 0x81, 0x51, 0xE7, 0x81, 0x1B, 0xC0, 0x81, 0xF6, 0x07}},
};

static char saturation_lut[5][12] = {
	{0x00, 0xBB, 0x80, 0x47, 0xCC, 0x7C, 0x77, 0xCC, 0xCC, 0xCC, 0x00, 0x00},
	{0x00, 0xBB, 0x80, 0x47, 0xEE, 0xDE, 0xDD, 0xEE, 0xEE, 0xEE, 0x00, 0x00},
	{0x00, 0xBB, 0x80, 0x47, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x0F},
...
static void lge_display_control_store_rm69299(struct dsi_panel *panel, bool send_cmd)
{
	...
	if (!bc_payload || !cm_payload || !sharpness_payload || !sharpness_level_payload) {
...
static void lge_set_screen_mode_rm69299(struct dsi_panel *panel, bool send_cmd)
{
	...
	case screen_mode_expert:
		...
		/* To Do
		mutex_unlock(&panel->panel_lock);
		lge_set_custom_rgb_rm69299(panel, send_cmd);
		mutex_lock(&panel->panel_lock);
		*/
		break;
	case screen_mode_cinema:
