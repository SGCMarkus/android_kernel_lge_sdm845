...
/* Kernel Debug Macros */
#ifdef __KERNEL__
    asmlinkage void _Dw7912DbgOut(int level, const char *format,...);
    asmlinkage void _Dw7912DbgOutTemp(const char *format,...);
    asmlinkage void _DW7912DbgOutFatal(const char *format,...);
    asmlinkage void _Dw7912DbgOutErr(const char *format,...);
    asmlinkage void _Dw7912DbgOutWarn(const char *format,...);
    asmlinkage void _Dw7912DbgOutInfo(const char *format,...);
    asmlinkage void _Dw7912DbgOutVerbose(const char *format,...);
    asmlinkage void _Dw7912DbgOutOverkill(const char *format,...);

    #define DbgOut(_x_)  _Dw7912DbgOut _x_
    #define DbgOutTemp(_x_) _Dw7912DbgOutTemp _x_
    #define DbgOutFatal(_x_) _DW7912DbgOutFatal _x_
    #define DbgOutErr(_x_) _Dw7912DbgOutErr _x_
    #define DbgOutWarn(_x_) _Dw7912DbgOutWarn _x_
    #define DbgOutInfo(_x_) _Dw7912DbgOutInfo _x_
    #define DbgOutVerbose(_x_) _Dw7912DbgOutVerbose _x_
    #define DbgOutOverkill(_x_) _Dw7912DbgOutOverkill _x_
