...
int Pmi8998SaveOutputData(const char *outputDataBuffer, int count)
{
    /* Check buffer size */
...
bool Pmi8998SendOutputData(void)
{
...
void Pmi8998ResetOutputData(void)
{
    g_nOutputData = 0;
    g_bOutputDataBufferEmpty = 1;
}

bool Pmi8998IsOutputDataBufferEmpty(void)
{
