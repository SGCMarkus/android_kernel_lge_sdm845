...
/* Kernel Debug Macros */
#ifdef __KERNEL__
    asmlinkage void _Pmi8998DbgOut(int level, const char *format,...);
    asmlinkage void _Pmi8998DbgOutTemp(const char *format,...);
    asmlinkage void _Pmi8998DbgOutFatal(const char *format,...);
    asmlinkage void _Pmi8998DbgOutErr(const char *format,...);
    asmlinkage void _Pmi8998DbgOutWarn(const char *format,...);
    asmlinkage void _Pmi8998DbgOutInfo(const char *format,...);
    asmlinkage void _Pmi8998DbgOutVerbose(const char *format,...);
    asmlinkage void _Pmi8998DbgOutOverkill(const char *format,...);

    #define DbgOut(_x_)  _Pmi8998DbgOut _x_
    #define DbgOutTemp(_x_) _Pmi8998DbgOutTemp _x_
    #define DbgOutFatal(_x_) _Pmi8998DbgOutFatal _x_
    #define DbgOutErr(_x_) _Pmi8998DbgOutErr _x_
    #define DbgOutWarn(_x_) _Pmi8998DbgOutWarn _x_
    #define DbgOutInfo(_x_) _Pmi8998DbgOutInfo _x_
    #define DbgOutVerbose(_x_) _Pmi8998DbgOutVerbose _x_
    #define DbgOutOverkill(_x_) _Pmi8998DbgOutOverkill _x_
