...
#include <uapi/linux/sched.h> /* LGE_CHANGE, fix to occupy cpu of RT Thread 2018-12-28 */
...
/* LGE_CHANGE_S, fix to occupy cpu of RT Thread 2018-12-28 */
static bool cam_is_rt_policy(unsigned int policy)
{
	return policy == SCHED_FIFO || policy == SCHED_RR;
}
/* LGE_CHANGE_E, fix to occupy cpu of RT Thread 2018-12-28 */
