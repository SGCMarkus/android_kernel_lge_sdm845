...
#if defined (CONFIG_MACH_SDM845_JUDYPN)  || defined (CONFIG_MACH_SDM845_STYLE3LM_DCM_JP) || defined(CONFIG_MACH_SDM845_CAYMANSLM)
	...
	case CAM_ACTUATOR_PACKET_OPCODE_INIT:
		...
		for (i = 0; i < csl_packet->num_cmd_buf; i++) {
			...
			case CAMERA_SENSOR_CMD_TYPE_PWR_DOWN:
				...
				break;
			default:
#if defined (CONFIG_MACH_SDM845_JUDYPN) || defined (CONFIG_MACH_SDM845_STYLE3LM_DCM_JP) || defined(CONFIG_MACH_SDM845_CAYMANSLM) // QCT original , need to block code for judy
				CAM_DBG(CAM_ACTUATOR,
        ...
        /* LGE_CHANGE_S, 2020-04-24, OIS,AF Driver update for LG EIS, kh.kang@lge.com */
#if defined (CONFIG_MACH_SDM845_JUDYPN) || defined (CONFIG_MACH_SDM845_STYLE3LM_DCM_JP) || defined(CONFIG_MACH_SDM845_CAYMANSLM)
        // AF Hall buffer reset
        memset(&(a_ctrl->buf), 0, sizeof(struct msm_act_readout_buffer));
#endif
        /* LGE_CHANGE_E, 2020-04-24, OIS,AF Driver update for LG EIS, kh.kang@lge.com */
