...
typedef struct {
	...
	uint8_t laser_offset_calibrate;
} VL53L0_offset_Calibration_t;
...
struct stmvl53l0_data {
	...
	uint8_t aat_mode;
	VL53L0_offset_Calibration_t offset_cal_data;
	int8_t ldaf_thread_pause;
	int8_t ldaf_thread_pause_prev;
};
