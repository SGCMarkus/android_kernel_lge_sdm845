...
#if defined(CONFIG_MACH_SDM450_CV7A_LAO_COM) || defined(CONFIG_MACH_SDM845_JUDYLN) || defined(CONFIG_MACH_SDM845_JUDYPN) || defined(CONFIG_MACH_SDM845_STYLE3LM_DCM_JP)
