...
struct adm_tx_voice_focus_param {
	struct adm_cmd_set_pp_params_v5     params;
	struct adm_param_data_v5            data;
	struct tx_ac_voicefocus_param_t     tx_control_param;
} __packed;

struct adm_tx_deviceinfo_param {
	struct adm_cmd_set_pp_params_v5     params;
	struct adm_param_data_v5            data;
	struct tx_ac_deviceinfo_param_t     tx_control_param;
} __packed;

struct adm_tx_lgemixer_mixinglevel_param {
	struct adm_cmd_set_pp_params_v5     params;
	struct adm_param_data_v5            data;
	struct lgemixer_mixinglevel_t       tx_control_param;
} __packed;
